\begin{figure*}[!htbp] 
    ...
    \begin{tikzpicture}[node distance = 2cm, auto]
        ...
        \node [instance, above of=CONTRACT2,  node distance=4cm] (CONTRACT1) {Consent Contract 1};
        \node [instance, below of=CONTRACT2,  node distance=4cm] (CONTRACT3) {Consent Contract ...};
        % Draw edges
        \path [line] (DAO) -- node {upgrade} (FACTORY);
        \path [line] (FACTORY) |- node [near start] {deploy} (CONTRACT1);
        \path [line] (FACTORY) -- node {deploy} (CONTRACT2);
        \path [line] (FACTORY) |- node [near start] {deploy} (CONTRACT3);
    \end{tikzpicture}
