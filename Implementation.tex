...
\include{ConsentContractPubSubTikz}
...
\include{OnChainOffChainInteractionTikz}
...
such as Google Storage, Amazon S3, or decentralized options like Ceramic Network.
