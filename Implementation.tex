...
A ratchet is a simple machine that only allows for state increments in one direction and prevents backward traversal of the state path. Likewise, a cryptographic
