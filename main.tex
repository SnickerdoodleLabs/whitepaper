...
\usepackage{hyperref, graphicx, floatrow, tikz, float} % adds linking on the doc
\usetikzlibrary{chains,mindmap,tree,shapes,arrows,backgrounds,fit,algpseudocode}
